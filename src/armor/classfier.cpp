...
#include "../../include/armor/classfier.h"
#include <cstdio>
#include <iostream>
...
MatrixXd Classifier::load_fc_w(const string &file)
{
    ...
    /*a little bug here*/
    /*
    fscanf_s(fp, "%d %d", &col, &row);
    MatrixXd mat(row, col);
    for (int c = 0; c < col; c++) {
        for (int r = 0; r < row; r++) {
            fscanf_s(fp, "%lf", &mat(r, c));
        }
    }*/
...
{
    // conv1_w = load_conv_w("detect_armor/src/tools/para/conv1_w");
